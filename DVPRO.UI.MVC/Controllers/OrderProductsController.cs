...
namespace DVPRO.UI.MVC.Controllers
{
    ...
    public class OrderProductsController : Controller
    {
        ...
        public OrderProductsController(DVPROContext context)
        {
            _context = context;
        }
        ...
        {
            var dVPROContext = _context.OrderProducts.Include(o => o.Order).Include(o => o.Product);
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'DVPROContext.OrderProducts'  is null.");
            }
            var orderProduct = await _context.OrderProducts.FindAsync(id);
            if (orderProduct != null)
            {
