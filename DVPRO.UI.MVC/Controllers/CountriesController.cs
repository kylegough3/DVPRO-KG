...
namespace DVPRO.UI.MVC.Controllers
{
    ...
    public class CountriesController : Controller
    {
        ...
        public CountriesController(DVPROContext context)
        {
            _context = context;
        }
        ...
        {
            var dVPROContext = _context.Countries.Include(c => c.Region);
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'DVPROContext.Countries'  is null.");
            }
            var country = await _context.Countries.FindAsync(id);
            if (country != null)
            {
