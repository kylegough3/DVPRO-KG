...
namespace DVPRO.UI.MVC.Controllers
{
    ...
    public class ProductStatusController : Controller
    {
        ...
        public ProductStatusController(DVPROContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.ProductStatuses != null ? 
                          ...
                          Problem("Entity set 'DVPROContext.ProductStatuses'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'DVPROContext.ProductStatuses'  is null.");
            }
            var productStatus = await _context.ProductStatuses.FindAsync(id);
            if (productStatus != null)
            {
