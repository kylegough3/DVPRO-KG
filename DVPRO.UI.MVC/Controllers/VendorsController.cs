...
namespace DVPRO.UI.MVC.Controllers
{
    ...
    public class VendorsController : Controller
    {
        ...
        public VendorsController(DVPROContext context)
        {
            _context = context;
        }
        ...
        {
            var dVPROContext = _context.Vendors.Include(v => v.Country);
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'DVPROContext.Vendors'  is null.");
            }
            var vendor = await _context.Vendors.FindAsync(id);
            if (vendor != null)
            {
