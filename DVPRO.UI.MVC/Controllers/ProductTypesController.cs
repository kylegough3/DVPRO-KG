...
namespace DVPRO.UI.MVC.Controllers
{
    ...
    public class ProductTypesController : Controller
    {
        ...
        public ProductTypesController(DVPROContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.ProductTypes != null ? 
                          ...
                          Problem("Entity set 'DVPROContext.ProductTypes'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'DVPROContext.ProductTypes'  is null.");
            }
            var productType = await _context.ProductTypes.FindAsync(id);
            if (productType != null)
            {
