...
namespace DVPRO.UI.MVC.Controllers
{
    ...
    public class DepartmentsController : Controller
    {
        ...
        public DepartmentsController(DVPROContext context)
        {
            _context = context;
        }
        ...
        {
            var dVPROContext = _context.Departments.Include(d => d.Location);
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'DVPROContext.Departments'  is null.");
            }
            var department = await _context.Departments.FindAsync(id);
            if (department != null)
            {
