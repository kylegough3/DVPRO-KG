...
namespace DVPRO.UI.MVC.Controllers
{
    ...
    public class LocationsController : Controller
    {
        ...
        public LocationsController(DVPROContext context)
        {
            _context = context;
        }
        ...
        {
            var dVPROContext = _context.Locations.Include(l => l.Country);
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'DVPROContext.Locations'  is null.");
            }
            var location = await _context.Locations.FindAsync(id);
            if (location != null)
            {
